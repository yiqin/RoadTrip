...
class MyProfileViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SoftwareProjectTableViewCellDelegate, AppTableViewCellDelegate {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: NSBundle?) {
        ...
        tempBackgroundImageView.image = UIImage(named: "profileBackgroundImage1")
        ...
        let taglineLabelWidth:CGFloat = 200
        taglineLabel.text = "Hiking, Camping, and Fishing"
        ...
        tableView.frame = CGRectMake(0, 0, screenWidth, screenHeight-44)
