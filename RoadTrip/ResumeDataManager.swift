...
public class ResumeDataManager: NSObject {
    ...
    override init() {
        ...
        let quote1 = Quote(text: "People don’t take trips, trips take people.", backgroundImage: UIImage(named: "backgroundImage1")!)
        let quoteSection1 = QuoteSection()
        quoteSection1.rowObjects = [quote1]
        
        
        let quote2 = Quote(text: "Play hard work hard", backgroundImage: UIImage(named: "profileBackgroundImage1")!)
        ...
        let quote4 = Quote(text: "You don’t have to be rich to travel well.", backgroundImage: UIImage(named: "backgroundImage4")!)
        let quoteSection4 = QuoteSection()
        quoteSection4.rowObjects = [quote4]
        
        
        let quote5 = Quote(text: "Oh the places you’ll go.", backgroundImage: UIImage(named: "profileBackgroundImage2")!)
        ...
        let content1 = Content(title: "I like hiking, camping and fishing. \n\nI was born in China. Three years ago, I came to U.S to pursue my dream of becoming a mechanical engineer. \n\nI accidently went to a hackathon with 500+ hackers in Juanary 2014. I was shocked by the passion and the creativity of programmers who were from all over the country.")
        ...
        let contentSection2 = ContentSection()
        contentSection2.text = "Moments"
        ...
        contentSection2.rowObjects = [hackathonImageSet]
        ...
        */
        ...
        // objects = NSArray(array: [profileSummarySection, BlankSection(), contentSection1, BlankSection(), quoteSection1, BlankSection(), softwareProjectSection1, BlankSection(), quoteSection2, BlankSection(), hackathonSection, BlankSection(), quoteSection3, BlankSection(), openSourceSection, BlankSection(), quoteSection4, BlankSection(),educationSection,BlankSection(),robotSection,BlankSection(), quoteSection5])
        
        objects = NSArray(array: [profileSummarySection, BlankSection(), contentSection1, BlankSection(), contentSection2, BlankSection(), quoteSection1, BlankSection(), hackathonSection, quoteSection4, BlankSection(),robotSection, BlankSection(), quoteSection5])
    ...
    func getObject(indexPath: NSIndexPath) -> AnyObject {
        ...
        switch cellClassName {
            ...
            case "RoadTrip.ProfileSummarySection":
            ...
            case "RoadTrip.SoftwareProjectSection":
